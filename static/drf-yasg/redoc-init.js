...
function hideEmptyVersion() {
    // 'span.ShortenYourLink-info-version' is for redoc 1.x, 'div.ShortenYourLink-info span' is for redoc 2-alpha
    var apiVersion = document.querySelector('span.ShortenYourLink-info-version') || document.querySelector('div.ShortenYourLink-info span');
    if (!apiVersion) {
        console.log("WARNING: could not find API versionString element (span.ShortenYourLink-info-version)");
        return;
    }
...
if (document.querySelector('span.ShortenYourLink-info-version') || document.querySelector('div.ShortenYourLink-info span')) {
    hideEmptyVersion();
}
else {
    insertionQ('span.ShortenYourLink-info-version').every(hideEmptyVersion);
    insertionQ('div.ShortenYourLink-info span').every(hideEmptyVersion);
}
